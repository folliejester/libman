...
<%
	...
	String sql = "SELECT tblstudents.FullName,tblbooks.BookName,tblbooks.ISBNNumber,tblissuedbookdetails.IssuesDate,tblissuedbookdetails.ReturnDate,tblissuedbookdetails.DueDate,tblissuedbookdetails.id as rid,tblissuedbookdetails.fine,tblissuedbookdetails.RetrunStatus from  tblissuedbookdetails join tblstudents on tblstudents.StudentId=tblissuedbookdetails.StudentId join tblbooks on tblbooks.id=tblissuedbookdetails.BookId where tblissuedbookdetails.id=?";
...
<span style="color:red" ><b><%="Book Not Returned" %></b></span>
<% }else{ %>
<span style="color:green"><b><%="Book Returned" %></b></span>
</form>
...
{ 
	...
	if(ret!=null)
	{
		...
		int rstatus=1;
		sql="update tblissuedbookdetails set ReturnDate=?,RetrunStatus=?,fine = ? where id=?";
